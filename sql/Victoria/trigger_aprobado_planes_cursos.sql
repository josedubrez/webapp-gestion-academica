create or replace function f_tr_upd__aprobado__planes_cursos()
returns trigger as $$
declare
...
create trigger tr_upd__aprobado__planes_cursos
after update of aprobado on planes_cursos
for each row
execute function f_tr_upd__aprobado__planes_cursos();